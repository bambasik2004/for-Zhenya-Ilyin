...
if __name__ == '__main__':
    ...
    # G - графики
    plt.figure('G')
    plt.plot(calc.N_range, [calc.G] * len(calc.N_range), label='G')
    plt.plot(calc.N_range, G_fdtd_list, label='G_fdtd')
    plt.plot(calc.N_range, G_volna_list, label='~G')
    plt.legend()
    plt.xlabel('Nl')
    # d_G
    plt.figure('d_G')
    plt.plot(calc.N_range, d_g_list, label='d_G')
    plt.legend()
    plt.xlabel('Nl')
    # T
    plt.figure('T')
    plt.plot(calc.N_range, [calc.T] * len(calc.N_range), label='G')
    plt.plot(calc.N_range, T_fdtd_list, label='G_fdtd')
    plt.plot(calc.N_range, T_volna_list, label='~G')
    plt.legend()
    plt.xlabel('Nl')
    # d_T
    plt.figure('d_T')
